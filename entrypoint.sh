...
do
  ...
  sed -i 's|VUE_APP_API_URL_PLACEHOLDER|'${VUE_APP_IMAGE_MANAGER_API_URL}'|g' $file
  ...
  sed -i 's|VUE_APP_USER_MANAGER_GUI_URL_PLACEHOLDER|'${VUE_APP_USER_MANAGER_GUI_URL}'|g' $file
